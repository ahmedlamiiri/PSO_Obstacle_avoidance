...
from RandomSolution2 import RandomSolution
from PlotSolution1 import PlotSolution
from creatmodel1 import TerrainModel
from MyCost1 import PathCostCalculator
from Spherical_to_cart1 import SphericalToCartesian

class PSO:
    def __init__(self, TerrainModel, max_it=100, n_pop=200):
        ...
        vertical_angle_range = np.pi/36  # Very small range for almost fixed altitude
        ...
        for it in range(self.max_it):
            ...
            for particle in self.particles:
                ...
                for key in ['r', 'psi', 'phi']:
                    ...
                    # Velocity Mirroring
                    out_of_range = (particle['position'][key] < self.var_min[key]) | (particle['position'][key] > self.var_max[key])
    ...
    def plot_results(self):
        ...
        plot_model = {
            'X': self.TerrainModel.X,
            'Y': self.TerrainModel.Y,
            'H': self.TerrainModel.H,
            'start': self.TerrainModel.start_location,
            'end': self.TerrainModel.end_location,
            'threats': self.TerrainModel.threats
        }
...
if __name__ == "__main__":
    # Get configuration from creatmodel1.py
    from creatmodel1 import terrain_file, threats, bounds, start_location, end_location, n
