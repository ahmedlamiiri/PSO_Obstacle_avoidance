...
class PathCostCalculator:
    ...
    def calculate_cost(self, sol):
        ...
        for threat in threats:
            ...
            for j in range(N - 1):
                ...
                if dist > (threat_radius + drone_size + danger_dist):
                    ...
                    threat_cost = 1000 * ((threat_radius + drone_size + danger_dist) - dist)
                J2 += threat_cost
        ...
        J4 = 0
        turning_max = 25  # Even smoother turns
        climb_max = 20   # More stable altitude
